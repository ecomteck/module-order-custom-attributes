    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
     ...
     * @var string
     */
    protected $_nameInLayout = 'ecomteck_order_custom_attributes_form_edit_tab_conditions';
    ...
    {
        /* @var $form \Magento\Eav\Model\Form\Type */
        $form = $this->_coreRegistry->registry('current_form_type');
        $model = $form->getRule();
